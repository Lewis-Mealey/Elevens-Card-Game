public interface BagInterface<T> {
    ...
    /* test for spare capacity in the bag and if it exists, add the new element
     ...
     @return - (boolean) true if this item is added, false otherwise
     */
    ...
    @return - (boolean) true if the bag contains the elements, false otherwise
     */
...
//    Gets the index of whatever is specified
